...
class LetterController extends Controller
{
    ...
    {
        if (request()->ajax()) {
            $query = Letter::with(['department','branch','sender'])->where('letter_type', 'Surat Masuk')->latest()->get();
    ...
    {
        if (request()->ajax()) {
            $query = Letter::with(['department','branch','sender'])->where('letter_type', 'Surat Keluar')->latest()->get();
