                            ...
                            <form action="{{ route('user.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control @error('role_id') is-invalid @enderror" name="role_id" type="role_id"  required/>
                                        @error('role_id')
                                            <div class="invalid-feedback">
                                                {{ $message; }}
                                            </div>
                                ...
                                <div class="mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control @error('branch_id') is-invalid @enderror" name="branch_id" type="branch_id"  required/>
                                        @error('branch_id')
                                            <div class="invalid-feedback">
                                                {{ $message; }}
                                            </div>
                                ...
                                <div class="mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input class="form-control @error('department_id') is-invalid @enderror" name="department_id" type="department_id"  required/>
                                        @error('department_id')
                                            <div class="invalid-feedback">
                                                {{ $message; }}
                                            </div>
